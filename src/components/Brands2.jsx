...
function Brands2() {
  ...
  const testimonios = [
    ...
    },
    {
      ...
      title: "Vero carteras: ",
      subtitle:
        " “Mi modelo exclusiva, estás en el minuto a minuto, orgullosa de verte trabajar por lo que querés. Me encanta todo, enseguida ponés manos a la obra, estás ahí siempre. Sos lo mas Naty” ",
      number: "06",
    },
    {
...

    {
      ...
      subtitle:
        "  “Un placer colaborar con vos, sos una inmensa mujer, poderosa, inteligente. A tu entera disposición. Vamos a compartirle magia a la gente, conexiones reales y emocionales.” ",
      number: "08",
    },
    {
  ...
  <div className={style.wrapper}>
      ...
      <p className={style.textBottom} data-aos="fade-up" data-aos-delay="50">
        Si crees que es momento de ordenar y potenciar tu marca, estoy lista
        para acompañarte.
      </p>
    </div>
  </div>
